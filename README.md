...
- Library view with search, filter (channel/status/resolution), and sort
...
- Deleting a channel removes its video rows from the library but does not delete already-downloaded files from disk.
